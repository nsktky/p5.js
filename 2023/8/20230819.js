...
class Particle {
  ...
  checkParticles(particles) {
    ...
    for (let i = 0; i < 3; i++) {
      ...
      stroke(d * 0.2, d * 0.4, d * 0.7);
      circle(distances[i].particle.pos.x, distances[i].particle.pos.y, d * 0.5);
      stroke(d * 0.1, d * 0.2, d * 0.2)
      line(this.pos.x, this.pos.y, distances[i].particle.pos.x, distances[i].particle.pos.y)
      stroke(d * 0.1, d * 0.1, d * 0.3);
      circle(this.pos.x, this.pos.y, d * 0.3);
    }
  }
}
