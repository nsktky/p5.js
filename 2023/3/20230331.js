...
function setup() {
  ...
  for (let i = 0; i < numParticles; i++) {
    particles.push(new Particle(random(width*0.4, width*0.6), random(height*0.4, height*0.6), random(-size*0.15, size*0.15)));
  }
}
...
class Particle {
  constructor(x, y, z) {
    ...
    this.hue = map(noise(this.pos.x, this.pos.y, frameCount), 0, 1, 100, 360);
  }
